    ...
    return (
        <div style={{ backgroundColor: '#ededed', minHeight: '50vh' }}>
            <Row className="order-container" style={{ maxWidth: 1260, margin: '0 auto' }}>
                <Col span={24} style={{ marginTop: 15, fontSize: 20, color: '#333', fontWeight: 500, padding: '10px', display: 'flex', alignItems: 'center' }}>
                    <span> GIỎ HÀNG </span>
                    <span style={{ fontSize: 15, margin: '0 0 2px 10px', color: '#444', fontWeight: 500 }}>     ({dataCart?.length} sản phẩm)</span>
                </Col>
                <Col span={24} >
                    <Row className="order-content" gutter={20} >
                        <Col className="order-item" xs={24} sm={24} md={24} lg={0} xl={0} xxl={0} style={{ marginTop: 5 }} >
                                                ...
                                                return (
                                                    <Col key={index} span={24} style={{ backgroundColor: '#fff', borderRadius: 5 }}>
                                                        <Row style={{ padding: '18px 10px' }} >
                                                            <Col onClick={() => handleNavigateDetailPage(item)} span={4} style={{ display: 'grid', placeItems: 'center' }}>
                                                                <Avatar size={80} shape="square" src={`${baseURL}/images/${item?.thumbnail}`} />
                                                            </Col>
                                                            <Col xs={18} sm={20} md={0} lg={0} xl={0} xxl={0} style={{ marginLeft: 'auto' }} >
                                                                <Row gutter={[0, 7]}>
                                                                    <Col onClick={() => handleNavigateDetailPage(item)} span={24} style={{ color: '#333333', maxHeight: 35, overflow: 'hidden' }}>
                                                                        {item?.mainText}
                                                                    </Col>
                        ...
                        <Col className="order-item" xs={0} sm={0} md={0} lg={9} xl={9} xxl={9} style={{ marginTop: 15 }} >
                            <Row style={{ backgroundColor: '#fff' }}>
